                        ...
                        {products.slice(0, 4).map((p, idx) => (
                            <div key={idx} className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg transition-colors">
                                ...
                                <div className="text-right">
                                    <p className="font-bold text-gray-900 text-sm">${(p.stock * p.cost).toLocaleString()}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <div className="relative pt-4">
                        ...
                        <div className="mt-8 p-4 bg-yellow-50 rounded-lg border border-yellow-100">
                            ...
                            <p className="text-xs text-yellow-700">El depósito C-01 está alcanzando su capacidad máxima. Se recomienda revisión.</p>
                        </div>
                    </div>
                </div>
            </div>
